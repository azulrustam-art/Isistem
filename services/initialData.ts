...
export const INITIAL_INVENTORY_DATA: InventoryItem[] = [
  ...
  createItem(502, "LCD FULL SET (GX OLED) IP 12", 165, "Screen"),
  createItem(503, "LCD FULL SET (GX OLED) IP 13", 175, "Screen"),
  createItem(504, "LCD FULL SET (GX OLED) IP 14", 175, "Screen"),
